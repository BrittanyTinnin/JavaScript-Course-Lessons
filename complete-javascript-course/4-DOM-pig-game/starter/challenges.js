...
document.querySelector('.btn-hold').addEventListener('click', function () {
  if (gamePlaying) {
    ...
    //Undefined, 0, null 0r "" are COERCED to false
...
//function called by another function is a callback function

//need a state variable, we'll use it to remember something about our app
